...
**Evidence:** this pattern is the direct, traceable reason RP-001's negative result was reported honestly rather than rationalized away (see `architecture/FAOS_RP001_CASE_STUDY.md`, "value of pre-registration... demonstrated, not asserted"). It was designed ad hoc for RP-001; it should not need to be designed ad hoc again.
