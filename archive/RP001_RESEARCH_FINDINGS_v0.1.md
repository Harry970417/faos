...
- **Sample is a 50-stock characterization panel** (taiwan-attention-signal's existing large-cap-weighted list), not RP-001's full designed research universe (TWSE/TPEx, survivorship-bias-free) specified in `research/RP001_RESEARCH_DESIGN.md`. All findings above are scoped to this sample and require re-verification at full-universe scale before being treated as final.
