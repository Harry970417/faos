...
50 stocks, taiwan-attention-signal's existing large-cap-weighted panel — not RP-001's designed full research universe (`research/RP001_RESEARCH_DESIGN.md` specifies full TWSE + TPEx, survivorship-bias-free). Every finding in this report is scoped to this sample and requires re-verification at full scale before being treated as final — this is the entire reason Phase 2A exists as a separate workstream rather than a formality.
