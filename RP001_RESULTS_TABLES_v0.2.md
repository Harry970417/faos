...
Confirmatory-phase tables. Exploratory-phase tables (`RP001_RESULTS_TABLES_v0.1.md`) preserved unchanged as the historical record — not reproduced here. Source: `rp001_data/phase2a/processed/rp001_confirmatory_test_results.json`.
