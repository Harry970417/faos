...
**Date:** 2026-08-03. Full detail (machine-readable): `rp001_data/phase2a/processed/rp001_dataset_snapshot.json`. Test code: `research/rp001_phase2a_coverage_and_tests.py`.
...
They confirm the dataset is **internally consistent and free of the specific leakage/construction defects checked** — not that the confirmatory hypotheses will replicate. No IC, t-stat, or hypothesis test is computed in this report; that is Phase 2A.4 (`research/RP001_PHASE2A_CONFIRMATORY_RESULTS.md`).
