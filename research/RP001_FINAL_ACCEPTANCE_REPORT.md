...
`research/RP001_PHASE2A_PROTOCOL_LOCK.md` locked 2026-07-11 (commit `82bc4a3`). All six locked documents remained unmodified in place throughout Phase 2A execution; every deviation was logged before the affected test ran, per `research/RP001_DEVIATION_POLICY.md`. No Escalating Deviation was ever triggered — F_INST_01's definition, rank normalization, return-horizon construction, and the break interval's boundary dates were never reopened.
...
| H-C2 (post-break null) | Replicated (weak — see `research/RP001_PHASE2A_HYPOTHESIS_VERDICTS.md` caveat) |
