...
`RP001_LIMITATIONS_v0.1.md` (exploratory-phase limitations) is preserved unchanged — most of it (data-source share-count proxy, no causal design, no portfolio/backtest work) applies identically to Phase 2A and is not repeated here. This document adds what is new to Phase 2A specifically.
