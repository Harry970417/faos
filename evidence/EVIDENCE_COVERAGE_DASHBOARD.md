...
**Day Zero baseline** — measured against `knowledge/knowledge_base_remediated_v0.1.psv`, the same fixed-point discipline used for Knowledge Base Baseline v0.2. Every future EvidenceOps population effort is compared against this, not against whatever it looked like mid-effort.
