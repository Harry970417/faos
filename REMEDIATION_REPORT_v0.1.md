...
Output file: `knowledge_base_remediated_v0.1.psv`. `knowledge_base_v0.2.psv` (the Baseline) is untouched and remains the fixed comparison point for any future remediation batch.
